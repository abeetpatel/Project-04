	...
	<div align="center">
		<form action="<%=ORSView.COLLEGE_LIST_CTL%>" method="post">
			...
			<table style="width: 100%">
				<tr>
					<td align="center"><label><b>name :</b></label> <%=HTMLUtility.getList("id", DataUtility.getStringData(bean.getId()), collegeList)%>
						<label><b>Address :</b></label> <input type="text" name="address"
						value="<%=ServletUtility.getParameter("address", request)%>">
						<label><b>State :</b></label> <input type="text" name="state"
